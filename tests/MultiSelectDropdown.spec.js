...
test("MultipleSelectDropdown", async ({ page }) => {
  ...
  // get all options element from dropdown as an array
  ...
  for (const option of optionslist) {
    ...
    if (optionText?.trim() === "Selection Item 2") {
      ...
      //   exit the loop because desired value is found
      break;
    }
  }

  //   final assertion to verify that the desired value /option is found in the dropdown
